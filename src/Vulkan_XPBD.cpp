...
struct ClothNode {
    ...
    static VkVertexInputBindingDescription getBindingDescription() {
        ...
        bindingDescription.stride = sizeof(ClothNode);
    ...
    static std::array<VkVertexInputAttributeDescription, 2> getAttributeDescriptions() {
        ...
        attributeDescriptions[0].offset = offsetof(ClothNode, pos);

        attributeDescriptions[1].binding = 0;
        attributeDescriptions[1].location = 1;
        attributeDescriptions[1].format = VK_FORMAT_R32G32B32A32_SFLOAT;
        attributeDescriptions[1].offset = offsetof(ClothNode, color);

        //attributeDescriptions[2].binding = 0;
        //attributeDescriptions[2].location = 2;
        //attributeDescriptions[2].format = VK_FORMAT_R32G32B32A32_SFLOAT;
        //attributeDescriptions[2].offset = offsetof(ClothNode, vel);
        //
        //attributeDescriptions[3].binding = 0;
        //attributeDescriptions[3].location = 3;
        //attributeDescriptions[3].format = VK_FORMAT_R32G32B32A32_SFLOAT;
        //attributeDescriptions[3].offset = offsetof(ClothNode, normal);
        //
        //attributeDescriptions[4].binding = 0;
        //attributeDescriptions[4].location = 4;
        //attributeDescriptions[4].format = VK_FORMAT_R32_SFLOAT;
        //attributeDescriptions[4].offset = offsetof(ClothNode, isFixed);
...
static std::vector<ClothNode> generateClothNodes(uint32_t width, uint32_t height, float spacing) {
    ...
    for (uint32_t y = 0; y < height; y++) {
        for (uint32_t x = 0; x < width; x++) {
            ...
            node.color = glm::vec4(x / (float)width, y / (float)height, 1.0f, 0.0f);
...
static std::vector<uint32_t> generateClothIndices(uint32_t width, uint32_t height) {
...
const std::vector<ClothNode> nodes = generateClothNodes(16, 16, 0.1f);
const std::vector<uint32_t> indices = generateClothIndices(16, 16);
...
private:
    ...
    void createGraphicsPipeline() {
        ...
        auto bindingDescription = ClothNode::getBindingDescription();
        auto attributeDescriptions = ClothNode::getAttributeDescriptions();
    ...
    void createShaderStorageBuffer() {
        ...
        std::vector<ClothNode> clothNodes(PARTICLE_COUNT);

        VkDeviceSize bufferSize = sizeof(ClothNode) * clothNodes.size();
